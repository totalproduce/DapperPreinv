...
{
    /// <summary>
    /// Entity for the PREINVTEMP_INVPRT table
    /// </summary>
    public partial class INVPRT : BaseDbModel<INVPRT, string>
    {
#region tableDefs
...
//            int size, int? prec, int? scale)
         ...
         PropertyHelper <INVPRT>.GetProperty(x => x.Cancelleddlv),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Curdesc),
         "CURDESC", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Delclarecno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dltrecno),
         "DLTRECNO", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvdeldate),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvinvoiceno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvordno),
         "DLVORDNO", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvpodno),
         "DLVPODNO", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvprghedno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvsaloffno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Dlvshpdate),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Extractsessionid),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Hofclarecno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Hofcstcode),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Invdate),
         "INVDATE", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Invoicetype),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Isediprg),
         "ISEDIPRG", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Ordcstcode),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Ordcustordno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Orddate),
         "ORDDATE", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Ordrecno),
         "ORDRECNO", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Ordsmnno),
         "ORDSMNNO", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Prcglbrecno),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Recno),
         "RECNO", // columnName
         false,                    //isKey
         false, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Saloffdesc),
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Sort1),
         "SORT1", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Sort2),
         "SORT2", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
         ...
         result.Add(new EntityPropDef(
         PropertyHelper <INVPRT>.GetProperty(x => x.Vatable),
         "VATABLE", // columnName
         false,                    //isKey
         true, //isNullable
         "",                       //refEntityName
