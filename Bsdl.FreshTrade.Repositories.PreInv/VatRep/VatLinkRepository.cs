...
namespace Bsdl.FreshTrade.Repositories.PreInv.VatRep
{
    public class VatLinkRepository : DapperRepositoryBase<DTOVatLink>, IVatLinkRepository
    {
        ...
        public VatLinkRepository(IUnitOfWork unitOfWorkCurrent, ICacheManagerFactory cacheManagerFactory)
            : base
            (
                unitOfWorkCurrent,
                cacheManagerFactory,
        ...
        protected override List<DTOVatLink> GetDataInternal(List<ISearchField> searchFields, CachingStrategy allowFromCache, uint? topRows)
        {
