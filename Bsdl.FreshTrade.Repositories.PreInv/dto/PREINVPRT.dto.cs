...
namespace Bsdl.FreshTrade.Repositories.PreInv.dto
{
    ...
    public class PreINVPRT 
    {
       ...
       [DataMember]              
        public int? Cancelleddlv {get;set;}
...
/*
  result.Cancelleddlv = item.Cancelleddlv;
...
/*
Cancelleddlv = item.Cancelleddlv,
