...
namespace Dapper
{
    ...
    public  struct CommandDefinition
    {
        ...
        internal IDbCommand SetupCommand(IDbConnection cnn, Action<IDbCommand, object> paramReader, Action<IDbCommand> onCommandCreated = null)
        {
...
#else
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null, Action<IDbCommand> onCommandCreated = null
#endif
)
        {
            var command = new CommandDefinition(sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.Buffered);
            return ExecuteImpl(cnn, ref command, onCommandCreated);
        }
        /// <summary>
        /// Execute parameterized SQL  
        /// </summary>
        ...
        private static int ExecuteImpl(this IDbConnection cnn, ref CommandDefinition command, Action<IDbCommand> onCommandCreated = null)
        {
            ...
            if (multiExec != null && !(multiExec is string))
            {
                ...
                try
                {
                    ...
                    using (var cmd = command.SetupCommand(cnn, null, onCommandCreated))
                    {
            ...
            return ExecuteCommand(cnn, ref command, param == null ? null : info.ParamReader, onCommandCreated);
        }
...
#region Implementation of IDictionary<string,object>
        ...
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        [Obsolete("This method is for internal usage only", false)]
        public static void PackListParameters(IDbCommand command, string namePrefix, object value, Action<IDbDataParameter> onParamCreated)
        {
            ...
            if (list != null)
            {
                if (FeatureSupport.Get(command.Connection).Arrays)
                {
                    ...
                    if (onParamCreated != null)
                    {
                        onParamCreated(arrayParm);
                    }
...
#pragma warning restore 618
        ...
        private static int ExecuteCommand(IDbConnection cnn, ref CommandDefinition command, Action<IDbCommand, object> paramReader, Action<IDbCommand> onCommandCreated = null)
        {
            IDbCommand cmd = null;
            bool wasClosed = cnn.State == ConnectionState.Closed;
            try
            {
                cmd = command.SetupCommand(cnn, paramReader, onCommandCreated);
                if (wasClosed) cnn.Open();
...
#pragma warning restore 618
    ...
    {
        public const DbType EnumerableMultiParameter = (DbType)(-1);
        ...
        partial class ParamInfo
        {
            ...
            public Action<IDbDataParameter> OnParamCreated { get; set; }
        }
...
#else
string name, object value = null, DbType? dbType = null, ParameterDirection? direction = null, int? size = null, Action<IDbDataParameter> onParamCreated = null
#endif
)
        {
            parameters[Clean(name)] = new ParamInfo() { Name = name, Value = value, ParameterDirection = direction ?? ParameterDirection.Input, DbType = dbType, Size = size, OnParamCreated = onParamCreated };
        }
...
#pragma warning disable 612, 618
                    SqlMapper.PackListParameters(command, name, val, param.OnParamCreated);
#pragma warning restore 612, 618
                ...
                else
                {
                    ...
                    if (add)
                    {
                        ...
                        if (param.OnParamCreated != null)
                        {
                            param.OnParamCreated(p);
                        }
    ...
    partial class FeatureSupport
    {
        ...
        private static readonly Dictionary<string, FeatureSupport> FeatureList = new Dictionary<string, FeatureSupport>(StringComparer.InvariantCultureIgnoreCase) {
                ...
                {"OracleConnection", new FeatureSupport {Arrays = true}}
		};
