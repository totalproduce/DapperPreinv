...
(
  ...
  FROM PREINVTEMP_INVTOT Tot
    ...
    INNER JOIN PREINVTEMP_INVPRT2 Prt2 on Prt2.DLVORDNO = Prt.DLVORDNO AND Prt2.DLVINVOICENO = Prt.DLVINVOICENO AND Tot.EXTRACTSESSIONID = Prt2.EXTRACTSESSIONID
